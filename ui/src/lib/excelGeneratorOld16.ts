...
export const generateInvoiceExcel = async (data): Promise<any> => {
    ...
    for (let i = 0; i < products.length; i++) {
        if (type !== "tiles") {
            ...
            if (products[i].length === 2) {
                ...
                worksheet.getCell('A' + row).alignment = { wrapText: true, horizontal: 'right', vertical: 'middle' };
                worksheet.getCell('A' + row).border = {
                    top: { style: 'thin', color: { argb: 'FF000000' } },     // black
                    left: { style: 'thin', color: { argb: 'FF000000' } },
                    bottom: { style: 'thin', color: { argb: 'FF000000' } },
        ...
        for (let i = 0; i < products.length; i++) {
            if (type !== "tiles") {
                ...
                if (products[i].length === 2) {
                    ...
                    worksheetCopy.getCell('A' + row).alignment = { wrapText: true, horizontal: 'right', vertical: 'middle' };
                    worksheetCopy.getCell('A' + row).border = {
                        top: { style: 'thin', color: { argb: 'FF000000' } },     // black
                        left: { style: 'thin', color: { argb: 'FF000000' } },
                        bottom: { style: 'thin', color: { argb: 'FF000000' } },
    ...
    for (let i = 0; i < products.length; i++) {
        ...
        if (products[i].length === 2) {
            ...
            packingList.getCell('A' + row).alignment = { wrapText: true ,horizontal: 'right' ,vertical: 'middle' };
